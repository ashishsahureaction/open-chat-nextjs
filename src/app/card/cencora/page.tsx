...
const Cencora = () => {
  return (
    <div className="h-screen flex items-center justify-center ">
      <div className="w-[500px] rounded-lg overflow-hidden shadow-md hover:scale-110 duration-700">
        ...
        <div className="py-10 px-6 grid grid-cols-1 gap-6">
          ...
          NextJs, ReactJs, JavaScript, NodeJs, Redux, ExpressJs,
          Tailwind, Jasmine, Typescript, StoryBook, SASS, HTML5.
          </p>
